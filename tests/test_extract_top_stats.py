...
def test_validate_multiple_seasons_summarizes_matches_mismatches_and_failures(monkeypatch):
  ...
  monkeypatch.setattr("extract_top_stats.load_or_fetch_season_validation_inputs", fake_load_or_fetch_season_validation_inputs)
  monkeypatch.setattr("extract_top_stats.validate_season_standings", fake_validate_season_standings)
...
"""
  ...
  monkeypatch.setattr("extract_top_stats.extract_games_from_listing_with_progress", fake_extract_games_from_listing_with_progress)
  monkeypatch.setattr("extract_top_stats.fetch_html", fake_fetch_html)
...
def test_extract_game_entrypoint_orchestrates_pipeline(monkeypatch):
  ...
  monkeypatch.setattr("extract_top_stats.fetch_html", fake_fetch_html)
  monkeypatch.setattr("extract_top_stats.parse_top_stats", fake_parse_top_stats)
  monkeypatch.setattr("extract_top_stats.parse_actions", fake_parse_actions)
...
def test_extract_game_by_id_builds_url_and_delegates(monkeypatch):
  ...
  monkeypatch.setattr("extract_top_stats.extract_game", fake_extract_game)
...
<html><body>
  <table>
    <tr><td>2025-09-16</td><td><a href="/Game/Events/1004308">game 1</a></td></tr>
    <tr><td>2025-09-16</td><td><a href="/Game/Events/1004309">game 2</a></td></tr>
    <tr><td>2025-09-18</td><td><a href="/Game/Events/1004310">other date</a></td></tr>
  </table>
</body></html>
"""
...
def test_extract_games_from_listing_scrapes_each_game(monkeypatch):
  listing_html = """
<html><body>
  <a href="/Game/Events/1004840">game 1</a>
  <a href="/Game/Events/1004841">game 2</a>
</body></html>
"""

  def fake_fetch_html(url):
    assert url == "https://stats.swehockey.se/Tournaments/SHL"
    return listing_html
